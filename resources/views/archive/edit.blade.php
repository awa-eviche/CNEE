...
<html lang="en">
 ...
 <select class="form-control" name="entreprise_id" id="entreprise_id" disabled>
                                <option value="{{ $archive->entreprise_id }}">
                                    {{ $archive->entreprise->nomentreprise ?? ' - ' }}
                                </option>
                            </select>
                            <input type="hidden" name="entreprise_id" value="{{ $archive->entreprise_id }}">
</div>

                        <div class="form-group">
                          <label for="nom">Type d'archive</label>
                          <input
                            type="text" class="form-control" id="type" name="type" value="{{ $archive->type?? ' - ' }}" />
                        </div>
