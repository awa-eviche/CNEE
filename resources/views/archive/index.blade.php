...
<html lang="en">
  ...
  <body>
    ...
    <a href="{{ route('archive.create') }}" class="btn btn-primary btn-round">
        <i class="fa fa-plus"></i> Ajouter une archive
    </a>
</div>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title" style="text-align:center">Liste des archives</h4>
                  </div>
                  <div class="card-body">
            ...
            @foreach($archives as $archive)
                ...
                <td>{{ $archive->entreprise->nomentreprise ?? ' - ' }}</td>
                    ...
                    <td>
                        <a href="{{ route('archive.show', ['archive' => $archive->id]) }}" class="btn btn-info btn-sm voir-plus">Voir Plus</a>
                    </td>
                </tr>
            @endforeach
