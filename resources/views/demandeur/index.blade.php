...
<html lang="en">
  ...
  <body>
    ...
    <div class="d-flex justify-content-center gap-2">
        ...
        <a href="{{ route('demandeur.edit', $dem->id) }}" class="btn btn-sm btn-primary">
            Modifier
        </a>

        
        <form action="{{ route('demandeur.destroy', $dem->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer ce demandeur ?')">
                Supprimer
            </button>
        </form>
    </div>
