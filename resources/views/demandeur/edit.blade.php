      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="row">
            <form action="{{ route('demandeur.update', $demandeur->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                    ...
                    <div class="row">
                      <div class="col-md-6 col-6">
                        <div class="form-group">
                          ...
                          <input
                            type="text" class="form-control" value="{{ old('nom', $demandeur->nom) }}" id="nom" name="nom" placeholder="Enter votre Nom" />
                        ...
                        <div class="form-group">
                          ...
                          <input
                            type="text" class="form-control"  value="{{ old('adresse', $demandeur->adresse) }}"id="adresse" name="adresse" placeholder="Votre adresse " />
        ...
        @endforeach
                      ...
                      <div class="form-group">
                          ...
                          <input
                            type="text"
                            class="form-control"
                            value="{{ old('prenom', $demandeur->prenom) }}"
                            id="prenom"
                            name="prenom"
                            placeholder="Prenom"
                          />
                        ...
                        <div class="form-group">
                          ...
                          <input  type="text" class="form-control" value="{{ old('lieunaissance', $demandeur->lieunaissance) }}"id="lieunaissance" name="lieunaissance"  placeholder="Votre lieu de naissance"  />
                        </div>
                        <div class="form-group">
    <label for="sexe">Sexe</label>
    <select class="form-control" id="sexe" name="sexe" value="{{ old('sexe', $demandeur->sexe) }}">
